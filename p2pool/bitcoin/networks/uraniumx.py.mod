...
POW_FUNC = lambda data: pack.IntType(256).unpack(__import__('argon2d_hash').getPoWHash(data))
...
ADDRESS_EXPLORER_URL_PREFIX = 'https://explorer.uraniumx.org/block/'
...
#SANE_TARGET_RANGE = (2**256//10000000000000 - 1, 2**256//16800000 - 1)
